...
const WorkplanTierRedirect = lazy(() =>
  import('./pages/strategy/workplans/tierRouting').then((m) => ({
    default: m.WorkplanTierRedirect,
  })),
);
const ManagingDirectorWorkplan = lazy(
  () => import('./pages/strategy/workplans/ManagingDirectorWorkplan'),
);
const DepartmentHeadWorkplan = lazy(
  () => import('./pages/strategy/workplans/DepartmentHeadWorkplan'),
);
        ...
        <Routes>
          ...
          >
            ...
            <Route
              ...
              element={
                <Guarded route="/employees/:id/edit">
                  <Suspense fallback={<PageLoader />}>
                    <EmployeeForm />
                  </Suspense>
                </Guarded>
            ...
            <Route
              ...
              element={
                <Guarded route="/employees/:id/profile">
                  <Suspense fallback={<PageLoader />}>
                    <EmployeeProfile />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="appraisal_cycles"
              element={
                <Guarded route="/appraisal_cycles">
                  <Suspense fallback={<PageLoader />}>
                    <AppraisalCycles />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="hr_admin/appraisal-cycles"
              element={
                <Guarded route="/hr_admin/appraisal-cycles">
                  <Suspense fallback={<PageLoader />}>
                    <AppraisalCycles />
                  </Suspense>
                </Guarded>
            ...
            <Route
              ...
              element={
                <Guarded route="/consent_management">
                  <Suspense fallback={<PageLoader />}>
                    <Consent />
                  </Suspense>
                </Guarded>
            ...
            <Route
              ...
              element={
                <Guarded route="/attendance/dashboard">
                  <Suspense fallback={<PageLoader />}>
                    <AttendanceDashboard />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="leave/oversight"
              element={
                <Guarded route="/leave/oversight">
                  <Suspense fallback={<PageLoader />}>
                    <LeaveOversight />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="strategy/strategic-plan"
              element={
                <Guarded route="/strategy/strategic-plan">
                  <Suspense fallback={<PageLoader />}>
                    <StrategicPlan />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="strategy/performance-contracts"
              element={
                <Guarded route="/strategy/performance-contracts">
                  <Suspense fallback={<PageLoader />}>
            ...
            <Route
              path="strategy/workplans"
              element={
                <Guarded route="/strategy/workplans">
                  <Suspense fallback={<PageLoader />}>
                    <Workplans />
                  </Suspense>
                </Guarded>
            ...
            >
              ...
              />
              <Route
                path="subsection-head"
                element={
                  <Suspense fallback={<PageLoader />}>
                    <SubsectionHeadWorkplan />
                  </Suspense>
                }
              />
            </Route>
            ...
            <Route
              ...
              element={
                <Guarded route="/strategy/reports">
                  <Suspense fallback={<PageLoader />}>
                    <StrategyReports />
                  </Suspense>
                </Guarded>
            ...
            <Route
              ...
              element={
                <Guarded route="/meetings/:id/edit">
                  <Suspense fallback={<PageLoader />}>
                    <CreateMeeting />
                  </Suspense>
                </Guarded>
            ...
            <Route
              ...
              element={
                <Guarded route="/meetings/:id/details">
                  <Suspense fallback={<PageLoader />}>
                    <MeetingsDashboard />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="meetings/:id/confirm"
              element={
                <Guarded route="/meetings/:id/confirm">
                  <Suspense fallback={<PageLoader />}>
                    <MeetingsDashboard />
                  </Suspense>
                </Guarded>
            ...
            />
            <Route
              path="hr/policies/sections/:id"
              element={
                <Guarded route="/hr/policies/sections/:id">
                  <Suspense fallback={<PageLoader />}>
                    <HrPolicies />
                  </Suspense>
                </Guarded>
            ...
            >
              ...
              <Route
                path="profile"
                element={
                  <Guarded route="/settings/profile">
                    <SettingsProfileTab />
                  </Guarded>
                }
              />
              <Route
                path="notifications"
                element={
                  <Guarded route="/settings/notifications">
              ...
              <Route
                path="security"
                element={
                  <Guarded route="/settings/security">
                    <SettingsSecurityTab />
                  </Guarded>
                }
              />
              ...
              <Route
                path="permissions"
                element={
                  <Guarded route="/settings/permissions">
              ...
              <Route
                path="monitoring"
                element={
                  <Guarded route="/settings/monitoring">
                    <Suspense fallback={<PageLoader />}>
                      <ErrorMonitoring />
                    </Suspense>
                  </Guarded>
              ...
              <Route
                path="hr-policies"
                element={
                  <Guarded route="/settings/hr-policies">
                    <Suspense fallback={<PageLoader />}>
                      <HrPolicyAdmin />
                    </Suspense>
                  </Guarded>
