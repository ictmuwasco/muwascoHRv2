...
export const PAGE_PERMISSIONS = {
  ...
  '/strategy/performance-contracts': {
    id: 'performance_contracts',
    permission: 'performance_contract:view',
  },
  ...
  '/settings/hr-policies/:id/history': {
    id: 'hr_policies_admin',
    permission: 'hr_policies:manage',
  },
 ...
 */
export const SETTINGS_VISIBILITY_PERMISSIONS = [
  'settings:view',
