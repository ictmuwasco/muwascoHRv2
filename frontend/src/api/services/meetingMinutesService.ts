...
const minutesService = {
  status: (meetingId: number) => api.get(`/meetings/${meetingId}/minutes/status`),

  options: (meetingId: number) => api.get(`/meetings/${meetingId}/minutes/options`),

  view: (meetingId: number) => api.get(`/meetings/${meetingId}/minutes`),
