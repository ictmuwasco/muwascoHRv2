...
export interface ApiClient {
  ...
  post: <T = unknown>(url: string, data?: unknown, config?: ApiConfig) => Promise<AxiosLikeResponse<T>>
  put: <T = unknown>(url: string, data?: unknown, config?: ApiConfig) => Promise<AxiosLikeResponse<T>>
