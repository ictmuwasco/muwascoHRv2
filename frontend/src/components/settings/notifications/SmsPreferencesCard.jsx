    ...
    <div className="flex items-start gap-4">
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-500 mt-1">
          A short clock-in reminder sent to your phone when a push notification cannot reach you.
        </p>
        ...
        <label className="mt-4 flex items-center gap-3 cursor-pointer select-none">
          ...
          />
          <span className="text-sm text-gray-800">Send me SMS attendance reminders</span>
        ...
        <dl className="mt-4 space-y-2 text-sm">
          ...
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <dd>
              {prefs.reminder_time} · SMS fallback after {prefs.sms_fallback_delay_minutes} min if
        ...
        <p className="mt-3 text-xs text-gray-400">
          Reminders are only sent on scheduled working days that are not public holidays and while
          you are not on approved leave. Already clocked in? No message is sent.
        </p>
      </div>
    </div>
  </Card>
