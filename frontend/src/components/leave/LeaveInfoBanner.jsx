  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg px-4 py-3 flex items-start space-x-3">
      ...
      <div className="text-sm">
        <p className="font-medium text-blue-900 dark:text-blue-200">Planning Roster</p>
        <p className="text-blue-800 dark:text-blue-300 mt-0.5">
          ...
          {financialYearName && ` for ${financialYearName}`}. It does not represent an approved
          leave application or actual leave taken.
        </p>
      </div>
    </div>
  );
