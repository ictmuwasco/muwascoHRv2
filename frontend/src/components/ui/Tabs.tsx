...
const Tabs = ({
  ...
  const variantStyles: Record<string, any> = {
    ...
    pills: {
      ...
      inactive:
        'text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-700 dark:hover:text-gray-200',
    },
    boxed: {
      container:
        'flex space-x-1 border border-gray-200 rounded-lg p-1 bg-gray-50 dark:border-slate-700 dark:bg-slate-900',
      tab: 'px-4 py-2 rounded-md text-sm font-medium transition-colors',
