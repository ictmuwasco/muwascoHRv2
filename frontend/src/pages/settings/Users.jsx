        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              ...
              <span className="font-medium text-gray-900">{resetUser.email}</span>
            </p>
            {(error || success) && (
              <div
                className={`px-4 py-3 rounded-md text-sm mb-4 ${error ? 'bg-red-50 border border-red-200 text-red-700' : 'bg-green-50 border border-green-200 text-green-700'}`}
              >
                {error || success}
              </div>
            )}
