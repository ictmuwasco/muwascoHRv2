          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-md p-6">
            ...
            {(modal.action === 'reject' || modal.action === 'invalidate') && (
              <div className="mb-4">
                ...
                <textarea
                  className="w-full border border-gray-300 dark:border-slate-600 rounded-md px-3 py-2 text-sm shadow-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
                  rows={3}
                  value={modal.reason}
