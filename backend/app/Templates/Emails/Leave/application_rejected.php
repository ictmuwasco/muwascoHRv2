...
<body>
<div class="container">
    <div class="header"><h2>Leave Application Rejected</h2></div>
    <div class="content">
        <p>Dear <strong><?= htmlspecialchars($employeeName) ?></strong>,</p>
        <p>We regret to inform you that your leave application has been <strong style="color:#c0392b">rejected</strong>.</p>
        <div class="details">
        ...
        <?php endif; ?>
        <p>Please contact HR if you have any questions or wish to discuss this decision.</p>
