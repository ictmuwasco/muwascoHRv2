 ...
 * Variables: $employeeName, $leaveType, $startDate, $endDate, $days, $delegateName, $systemUrl
 */
?>
<!DOCTYPE html>
...
.header{background:#7f8c8d;color:#fff;padding:20px;text-align:center;border-radius:5px 5px 0 0}
...
<body>
<div class="container">
    <div class="header"><h2>Leave Application Cancelled</h2></div>
    <div class="content">
        ...
        <p>Please note that <strong><?= htmlspecialchars($delegateName) ?></strong> has been notified that the delegation is no longer required.</p>
        <?php endif; ?>
